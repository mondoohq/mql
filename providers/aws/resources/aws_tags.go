...
// distinct from a resource that carries no tags: Backup raises it for resources
// it does not manage. A denied lookup is not this; it is a classified error
// (classifyAwsError), because a refusal is never a null.
//
