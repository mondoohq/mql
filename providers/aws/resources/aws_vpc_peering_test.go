...
// cache key, and neither may two connections. The key used to be the region and
// the VPC id, so every connection a VPC takes part in collapsed onto one entry
// per region and whichever side was built second returned the first one's
// CIDRs.
